...
public class GameNegative extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_negative);
        ...
        btn_next.setOnClickListener(v -> {
            ...
            if (userLife <= 0)
            {
                ...
                Intent intent = new Intent(GameNegative.this, Result.class);
